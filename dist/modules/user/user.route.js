...
router
  ...
  .get(
    ...
    user_controller_1.userController.getPlanDetails
  );
// user api
router
  .route('/review')
  .post(
    ...
    user_controller_1.userController.reviewPlatform
  );
router
  .route('/book-plan/:id')
  .post(verifyAuth_1.verifyUser, user_controller_1.userController.bookPlan);
router
  .route('/booking/review/:id')
  .post(verifyAuth_1.verifyUser, user_controller_1.userController.reviewPlan);
router
...
router
  ...
  .patch(
    verifyAuth_1.verifyUser,
    user_controller_1.userController.manageSchedule
  );
