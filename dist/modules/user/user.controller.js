...
const getAgencies = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.userService.getAgencies(paginationOptions, filter);
...
const getTourPlans = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paginationOptions = yield (0, pagination_1.pagination)(req.query);
    const filter = (0, pick_1.default)(req.query, user_constant_1.tourPlanFilterOptions);
    const result = yield user_service_1.userService.getTourPlans(paginationOptions, filter);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const getAgencyById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const reviewPlatform = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (error) {
        (0, sendResponse_1.default)(res, {
            ...
            success: false,
            message: ((_a = error.details[0]) === null || _a === void 0 ? void 0 : _a.message) || user_constant_1.userControllerMsg.reviewError,
            data: error.details,
        });
    }
    else {
        const userId = Number((_b = req.user) === null || _b === void 0 ? void 0 : _b.userId);
        const data = req.body;
        const result = yield user_service_1.userService.reviewPlatform(Object.assign(Object.assign({}, data), { userId }));
        (0, sendResponse_1.default)(res, {
            statusCode: http_status_codes_1.StatusCodes.OK,
            success: true,
...
const getLandingPageData = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const bookPlan = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (error) {
        (0, sendResponse_1.default)(res, {
            statusCode: http_status_codes_1.StatusCodes.NON_AUTHORITATIVE_INFORMATION,
            success: false,
            message: ((_c = error.details[0]) === null || _c === void 0 ? void 0 : _c.message) || user_constant_1.userControllerMsg.bookPlanError,
            data: error.details,
        });
    }
    else {
