...
const getTourPlans = (meta, filterOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma.plan.findMany({
        ...
        take,
        orderBy,
        where: Object.assign(Object.assign({}, queryOption), { deadline: {
                gt: new Date(),
            } }),
        select: {
            planName: true,
...
const getTourPlanById = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const reviewPlatform = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma.reviews.create({ data });
    return result;
});
const getLandingPageData = () => __awaiter(void 0, void 0, void 0, function* () {
...
const reviewPlan = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (alreadyReviewed) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, user_constant_1.userServiceMessage.alreadyReviewedPlan);
    }
    ...
    if (!validReview) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, user_constant_1.userServiceMessage.invalidPlanReview);
    }
    if (validReview.plan.departureTime > new Date()) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_ACCEPTABLE, user_constant_1.userServiceMessage.yetToExperience);
    }
    if ((validReview === null || validReview === void 0 ? void 0 : validReview.status) !== 'confirmed') {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, user_constant_1.userServiceMessage.notConfirmed);
    }
    const data = {
        rating,
        feedback,
...
const manageSchedule = (id, userId, status) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (getSchedule.status === 'confirmed' ||
