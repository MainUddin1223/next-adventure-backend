...
const createTourPlan = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma.plan.create({ data });
    return result;
  });
const updateTourPlan = (planId, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isValidPlan) {
      throw new apiError_1.default(
        ...
        agency_constant_1.agencyServiceMsg.updatePlanError
      );
    }
...
const getPlanDetails = (id, agencyId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma.plan.findFirst({ where: { id, agencyId } });
    return result;
  });
const getScheduledPlans = (meta, filterOptions, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllPlans = (meta, filterOptions, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { skip, take, orderBy, page } = meta;
    const queryOption = {};
    if (Object.keys(filterOptions).length) {
...
const manageSchedule = (id, agencyId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!getSchedule) {
      throw new apiError_1.default(
        500,
        agency_constant_1.agencyServiceMsg.deadlineExpireScheduleError
      );
    }
    let result;
    if (
      getSchedule.status === 'pending' ||
      getSchedule.status === 'requested'
    ) {
      ...
      throw new apiError_1.default(
        500,
        agency_constant_1.agencyServiceMsg.invalidStatusError
      );
    }
    return result;
  });
const agencyStatics = agencyId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const date = new Date();
