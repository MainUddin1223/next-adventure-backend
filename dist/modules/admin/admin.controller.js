...
const getUsers = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filter = (0, pick_1.default)(
      req.query,
      admin_constant_1.getUsersFilterOptions
    );
    const result = yield admin_service_1.adminService.getUsersOrAdmins(
      paginationOptions,
      filter,
      'user'
    );
...
const getAdmins = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const paginationOptions = (0, pagination_1.pagination)(req.query);
    const filter = (0, pick_1.default)(
      req.query,
...
const getAgencies = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.adminService.getAgencies(
      paginationOptions,
      filter
    );
    (0, sendResponse_1.default)(res, {
...
const getAgencyDetailsById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getUpcomingSchedules = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.adminService.upcomingSchedules(
      paginationOptions,
      filter
    );
    (0, sendResponse_1.default)(res, {
...
const getAllPlans = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.adminService.getAllPlans(
      paginationOptions,
      filter
    );
    (0, sendResponse_1.default)(res, {
...
const getPlanDetailsById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = Number(req.params.id);
...
const getBookings = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const paginationOptions = (0, pagination_1.pagination)(req.query);
    const filter = (0, pick_1.default)(
      req.query,
    ...
    const result = yield admin_service_1.adminService.getBookings(
      paginationOptions,
      filter
    );
    (0, sendResponse_1.default)(res, {
...
const getBookingById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = Number(req.params.id);
...
const manageSchedule = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (status == 'pending' || status === 'postponed') {
      const result = yield admin_service_1.adminService.manageSchedule(
        id,
        status
      );
      (0, sendResponse_1.default)(res, {
...
const releasePayoutByPlan = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = Number(req.params.id);
...
const releasePayoutByBooking = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = Number(req.params.id);
    const status = req.query.status;
    if (status == 'released' || status === 'postponed') {
      const result = yield admin_service_1.adminService.managePayout(
        id,
        status
      );
      (0, sendResponse_1.default)(res, {
