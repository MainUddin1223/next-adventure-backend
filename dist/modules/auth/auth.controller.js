      ...
      (0, sendResponse_1.default)(res, {
        ...
        message:
          ((_a = error.details[0]) === null || _a === void 0
            ? void 0
            : _a.message) || auth_constant_1.authResponseMessage.signUpFailed,
        data: error.details,
      });
    } else {
...
const registerAgency = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const { error } = yield auth_validation_1.agencyRegisterSchema.validate(
      req.body
    );
    if (error) {
      (0, sendResponse_1.default)(res, {
        ...
        success: false,
        message:
          ((_b = error.details[0]) === null || _b === void 0
            ? void 0
            : _b.message) ||
          auth_constant_1.authResponseMessage.agencyRegisterFailed,
        data: error.details,
      });
    } else {
...
const getProfileData = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _d, _e;
    const result = yield auth_service_1.authService.getProfile(
...
const deleteAccount = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _f;
    const result = yield auth_service_1.authService.deleteAccount(
      (_f = req.user) === null || _f === void 0 ? void 0 : _f.authId
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
      success: true,
...
const updateProfile = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const validateSchema =
      ((_g = req.user) === null || _g === void 0 ? void 0 : _g.role) ===
      'agency'
    ...
    if (error) {
      console.log(
        (_h = error.details[0]) === null || _h === void 0 ? void 0 : _h.message
      );
      throw new apiError_1.default(
        500,
        (_j = error.details[0]) === null || _j === void 0 ? void 0 : _j.message
      );
    }
    yield auth_service_1.authService.updateProfile(
      (_k = req === null || req === void 0 ? void 0 : req.user) === null ||
        _k === void 0
        ? void 0
        : _k.role,
      (_l = req === null || req === void 0 ? void 0 : req.user) === null ||
        _l === void 0
        ? void 0
        : _l.userId,
      req.body
