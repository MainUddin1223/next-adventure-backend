...
exports.updateUserProfileSchema =
  exports.updateAgencyProfileSchema =
  exports.agencyRegisterSchema =
...
exports.updateAgencyProfileSchema = joi_1.default
  .object({
...
exports.updateUserProfileSchema = joi_1.default
  .object({
    name: joi_1.default.string().optional().messages({
      'string.pattern.base': 'Please enter a valid name',
    }),
