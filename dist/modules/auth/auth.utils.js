...
const getUserAuthInfo = (id) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const authData = {
        ...
        role: (_a = result === null || result === void 0 ? void 0 : result.auth) === null || _a === void 0 ? void 0 : _a.role,
    };
...
const getAgencyAuthInfo = (id) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    ...
    const authData = {
        userId: result === null || result === void 0 ? void 0 : result.id,
        authId: result === null || result === void 0 ? void 0 : result.auth.id,
        role: (_b = result === null || result === void 0 ? void 0 : result.auth) === null || _b === void 0 ? void 0 : _b.role,
    };
    const accessToken = yield jwtToken_1.jwtToken.createToken(authData, config_1.default.jwt.jwt_access_secret, config_1.default.jwt.expires_in);
    return { accessToken, profileData: { profileImg: result === null || result === void 0 ? void 0 : result.profileImg } };
});
