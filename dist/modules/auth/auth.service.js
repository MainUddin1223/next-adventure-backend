...
const signUp = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { email, password } = payload,
      data = __rest(payload, ['email', 'password']);
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isUserExist) {
      throw new apiError_1.default(
        ...
        auth_constant_1.authServiceMessage.serverErrorMsg
      );
    }
    ...
    if (
      (isUserExist === null || isUserExist === void 0
        ? void 0
        : isUserExist.accountStatus) !== 'active'
    ) {
      throw new apiError_1.default(
        http_status_codes_1.StatusCodes.FORBIDDEN,
        `${auth_constant_1.authServiceMessage.accountStatusMsg} ${isUserExist.accountStatus}`
      );
    }
    if (isUserExist.role === 'agency') {
      const accessToken = yield (0, auth_utils_1.getAgencyAuthInfo)(
        isUserExist.id
      );
      return accessToken;
    } else {
      const accessToken = yield (0, auth_utils_1.getUserAuthInfo)(
        isUserExist.id
      );
      return accessToken;
    }
...
const updateProfile = (role, id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let result;
    if (role == 'agency') {
