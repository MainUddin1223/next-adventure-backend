...
const verifyAuthWithRole = allowedRoles => {
  return (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const decoded = jwtToken_1.jwtToken.verifyToken(
          token,
        ...
        if (
          !(isExist === null || isExist === void 0 ? void 0 : isExist.id) ||
          !allowedRoles.includes(
            (_a = isExist.auth) === null || _a === void 0 ? void 0 : _a.role
          )
        ) {
          return res.status(401).json({ message: 'Unauthorized' });
        }
...
const verifyAuth = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (
        (isExist === null || isExist === void 0
          ? void 0
          : isExist.auth.accountStatus) !== 'active'
      ) {
        return res.status(401).json({ message: 'Unauthorized' });
      }
      req.user = {
